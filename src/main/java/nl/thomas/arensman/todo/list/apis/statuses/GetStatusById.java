...
public class GetStatusById {
    ...
    private static final String SELECT_STATUS_WHERE_ID_STATEMENT = "SELECT * FROM `statuses` WHERE `status_id` = ?";
    ...
    public static ResultSet selectStatusWhereId (DataSource dataSource, int statusId) {
        try (Connection connection = dataSource.getConnection()) {
            PreparedStatement preparedStatement = connection.prepareStatement(SELECT_STATUS_WHERE_ID_STATEMENT);
